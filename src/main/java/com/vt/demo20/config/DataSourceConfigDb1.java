...
@Configuration
@MapperScan(basePackages = "com.vt.demo20.dao.db1", sqlSessionFactoryRef = "sqlSessionFactoryDb1", sqlSessionTemplateRef = "sqlSessionTemplateDb1")
